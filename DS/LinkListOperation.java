/**
 * @author Arushi---class to show all the functions of link list
 *
 */
	...
	public void sort() {
									...
									// of Linked list
		{
			...
			while (tempNode2.link != null) {
				if ((tempNode2.value) > (tempNode2.link.value)) {
					temp = tempNode2.value;
					tempNode2.value = tempNode2.link.value;
					tempNode2.link.value = temp;
				}
