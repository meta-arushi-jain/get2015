...
<body>
	<div id="container">
		<div id="top">Welcome to the amazing world of Cars...</div>
		<div id="header">
		...
		<div id="content">
			<p>
				Let's explore the world of amazing car.<br />Just on one click
				search your dream car and book now on lowest prices.
			</p>
			<h2 class="header2">Search Car</h2>
			<br>
			<form action="searchcar" method="post">
				<input type="checkbox" name="search" value="make">Search By
				Make <input type="checkbox" name="search" value="price">Search
				By budget<br /> <br /> <input type="submit" value="Search">
			</form>
			...
			<%
				...
				if (request.getParameter("make") != null) {
					...
					//getting list of model of this company
					List<String> modelList = service
							.getListOfModelOfCarBasedOnCompany((String) request
									.getParameter("make"));
			%>
			<br />
			<form action='#' method="post">
				<select name='make'><br />
					...
					%>
				</select><br /> <input type='submit' value='Get Model'><br /> <br />
			</form>
			<br />
			<form action='display' method="post">
				<input type="hidden" name="make"
					value="<%=request.getParameter("make")%>"> <select
					name='model'><br />
					<br />
					...
					%>
				</select> <br /> <input type='submit' value='View'>
			</form>
			<%
				}
			%>
		...
		<div id="sidebar">
			...
			<p>Now Buy car from your home.SEARCH...SELECT...BUY...and
				DRIVEEEEE.....</p>
			<p>&nbsp;</p>
		</div>
		<div class="clear" id="footer">
			<div align="center">
				Copyright 2015 <a href="#">www.carcapture.com</a> - All rights
				reserved |
			</div>
		</div>
	</div>
